...
use crate::parser::parser::{Parser, LeagueType};

#[tokio::main]
async fn main() {
    let p = Parser::new("https://www.mytischtennis.de/clicktt/HeTTV/22-23/verein/34031/TV-1861-Wallau/spielplan/", LeagueType::Liga).await;
    let document = p.html;
